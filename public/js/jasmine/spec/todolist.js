describe("TodoList Test Suite", function () {
    var selectedIndex;
    var sInput;
    var selectInputs;
    ...
    describe("when setSelectedIndexes(selectInputs) is called", function () {
        //Spec for sum operation
        it("should set selected indexes to '2'", function () {
            for (sInput; sInput < selectInputs.length; sInput++) {
                selectedIndex = "2";
            ...
            expect(selectInputs[0].selectedIndex).toEqual("2");
        });
    });
});
