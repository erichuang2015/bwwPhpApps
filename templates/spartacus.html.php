    ...
    <form action="" method="post" class="needs-validation" autocomplete="off" novalidate>
        <div id="spartacusSettings" class="row">
            <div class="col-md-4 mb-3">
                ...
                <select class="form-control d-block w-100" id="difficultyLvl" name="settings[difficultyLvl]" data-difficultyLvl="<?=$settings['difficultyLvl'] ?? '0'?>" required>
            ...
            <div class="col-md-4 mb-3">
                ...
                <select class="form-control d-block w-100" id="lightWeight" name="settings[lightWeight]" data-lightweight="<?=$settings['lightWeight'] ?? '0'?>" required>
                    <option value="">Choose...</option>
            ...
            <div class="col-md-4 mb-3">
                ...
                <select class="form-control d-block w-100" id="heavyWeight" name="settings[heavyWeight]" data-heavyweight="<?=$settings['heavyWeight'] ?? '0'?>" required>
                    <option value="">Choose...</option>
