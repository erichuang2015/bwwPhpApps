...
<div class="container">
    <form action="" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <div id="captionDiv" class="col-md-4 mb-3">
                    ...
                    <input id="caption" name="caption" type="text" css="form-control text" placeholder="optional" size="55" maxlength="55" autocomplete="off">
                </div>
            </div>
        </div>
        ...
        <em class="photo-limit">I'm sorry for limiting your uploads to only 10 images.  I'm providing this service for free, but the web storage costs me money.  To keep the the cost of storage for this site at a level I can afford it is necessary to limit the amount of images that are uploaded.</em>
    </form>
</div> <!-- /container -->
<hr>
