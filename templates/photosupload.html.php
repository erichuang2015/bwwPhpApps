...
<form action="" method="post">
  <div class="row">
    <div class="col-md-4 mb-3">
      <label for="photo">Select the photo to upload</label>
      ...
      <input id="photo" name="photo" type="file"><!-- add a regex to only allow file extensions of png and jpg -->
    ...
    <div class="col-md-4 mb-3">
        ...
        <img src="/css/vendor/open-iconic-master/svg/info.svg" alt="Information about caption." width="12px" height="12px"
            data-container="body" data-toggle="popover" data-placement="right" data-content="Provide an <b>optional</b> description of your image. Must be less than 100 characters.">
