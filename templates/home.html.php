...
<div class="container fill-height">
        ...
        <?php if (!$loggedIn) : ?>
          ...
          <div class="col-md-4">
            <h2>Fitness Apps</h2>
            <p>If you enjoy physical fitness activities as much as I do then you may find any or all of my fitness apps useful. The Spartacus Workout is a great workout for burning fat and getting cut. The Run Speed Calculator can help you determine the pace you need to maintain to meet your long-distance running goals. The Fitness Calculator can help you calculate your body fat percentage and BMI. Last but not least, the pyramid workout is a great strength training alternative to the popular 5x5 routine.</p>
          </div>
          <div class="col-md-4">
            <h2>Utility Apps</h2>
             <p>These apps are meant to help you get things done, and enjoy a better quality of life. The photo viewer is a simple photo gallery which allows you to upload and view your photos.  The To Do List and Shopping List apps do exactly what you would infer by their respective names. <!-- The To Do List, Shopping List, Calendar, and Calculator apps all do exactly what you would infer by their respective names. The notes app is a tool where you can store your notes in the cloud and have them available with you wherever you go as long as you have a browser and an internet connection.--></p>
          </div>
          <div class="col-md-4">
            <h2>Trifling Apps</h2>
            <p>These apps are of little real-world value. I only wrote them as a means to practice my coding skills. However, the Horoscope Generator may provide some entertainment value if you are looking for a laugh.</p>
          </div>
        </div>
